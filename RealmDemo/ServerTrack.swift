...
public class ServerTrack: RLMObject {
    ...
    public func toDictionary() -> [String:AnyObject] {
        ...
        // TODO: Use getServerTrackMetadata() method
        var i:UInt = 0
    ...
    //Naming issue : https://github.com/realm/realm-cocoa/issues/2720
    public func getServerTrackMetadata() -> [ServerTrackMetadata]? {
